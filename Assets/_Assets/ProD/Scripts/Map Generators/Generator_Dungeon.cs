	...
	public static class Generator_Dungeon
{
	...
	private static bool   alternativeCorridors     = false;
	...
	public static void SetSpecificProperties(string type_Abyss_, string type_Path_, string type_Wall_,
		...
		bool create_Doors_, int repeat_, bool frameMap_, bool alternativeCorridors_)
	{
		...
		repeat       = repeat_;
		frameMap     = frameMap_;
		alternativeCorridors     = alternativeCorridors_;
	}
	...
	public static Map Generate()
	{
		...
		MethodLibrary.PlaceStairs(map, 1, type_Path, "Exit");
