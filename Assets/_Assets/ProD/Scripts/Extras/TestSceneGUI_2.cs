...
namespace ProD
{
	public class TestSceneGUI_2 : MonoBehaviour 
	{
		...
		public float window_Height = 342;
		...
		public float button_Start_Y = 34;
		
		
		private WorldMap worldMap;
		private float worldMap_Size_X = 2f;
		private float worldMap_Size_Y = 2f;
		private float mapWidth = 33.0F;
		private float mapHeight = 33.0F;
		...
		void OnGUI () 
		{
			...
			GUI.Label(new Rect(window_Start_X + label_Start_X,window_Start_Y + label_Start_Y,label_Width,492), 
				"Press a button to preview a 2 by 2 map each 29 by 29 cells." 
				+ "\n" 
